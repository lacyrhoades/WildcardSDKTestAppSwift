...
@property (nonatomic, readonly, strong) NSURL * __nonnull webUrl;
...
@property (nonatomic, readonly, strong) NSDate * __nullable publicationDate;
@property (nonatomic, readonly, copy) NSString * __nullable source;
@property (nonatomic, readonly, copy) NSString * __nullable author;
@property (nonatomic, readonly, strong) NSDate * __nullable updatedDate;
@property (nonatomic, readonly, strong) NSDictionary * __nullable media;
@property (nonatomic, readonly, strong) NSURL * __nullable appLinkIos;
@property (nonatomic, readonly, strong) NSURL * __nullable primaryImageURL;
- (BOOL)supportsLayout:(WCCardLayout)layout;
@end
...
@property (nonatomic, strong) CardView * __nonnull cardView;
@property (nonatomic, strong) id <CardPhysicsDelegate> __nullable delegate;
...
/// See CardPhysics
@property (nonatomic, strong) CardPhysics * __nullable physics;

/// See CardViewDelegate
@property (nonatomic, strong) id <CardViewDelegate> __nullable delegate;

/// The visual source associated with this CardView
@property (nonatomic, strong) id <CardViewVisualSource> __null_unspecified visualSource;

/// The backing card for this CardView
@property (nonatomic, strong) Card * __null_unspecified backingCard;
...
@property (nonatomic, readonly, strong) NSDictionary * __nullable parameters;
...
@property (nonatomic, strong) CardView * __nullable cardView;
...
@property (nonatomic, strong) UIView * __null_unspecified hairline;
- (void)initialize;
- (void)adjustForPreferredWidth:(CGFloat)cardWidth;
- (void)update:(Card * __nonnull)card;
- (CGFloat)optimizedHeight:(CGFloat)cardWidth;
...
@property (nonatomic, readonly, strong) NSURL * __nonnull imageUrl;
...
@property (nonatomic, strong) WCImageView * __null_unspecified imageView;
...
@property (nonatomic, strong) UIButton * __null_unspecified readMoreButton;
...
@property (nonatomic, strong) UILabel * __null_unspecified paragraphLabel;
@property (nonatomic) UIEdgeInsets contentEdgeInset;
- (void)initialize;
- (void)adjustForPreferredWidth:(CGFloat)cardWidth;
- (void)update:(Card * __nonnull)card;
...
@property (nonatomic, readonly, copy) NSString * __nonnull title;
@property (nonatomic, readonly, strong) NSURL * __nonnull embedUrl;
@property (nonatomic, readonly, copy) NSString * __nullable abstractContent;
@property (nonatomic, readonly, copy) NSArray<NSString *> * __nullable keywords;
@property (nonatomic, readonly, strong) NSURL * __nullable appLinkIos;
@property (nonatomic, readonly, strong) NSURL * __nullable streamUrl;
@property (nonatomic, readonly, copy) NSString * __nullable streamContentType;
@property (nonatomic, readonly, strong) NSURL * __nullable posterImageUrl;
- (BOOL)isYoutube;
- (BOOL)isVimeo;
...
@property (nonatomic, strong) WCVideoView * __null_unspecified videoView;
...
@property (nonatomic, strong) WCVideoView * __null_unspecified videoView;
@property (nonatomic, strong) UILabel * __null_unspecified title;
@property (nonatomic, strong) UILabel * __null_unspecified kicker;
...
@property (nonatomic, strong) UIButton * __null_unspecified viewOnWebButton;
@property (nonatomic, strong) UIButton * __null_unspecified shareButton;
@property (nonatomic, strong) UIView * __null_unspecified hairline;
@property (nonatomic) UIEdgeInsets contentEdgeInset;
- (void)initialize;
- (void)adjustForPreferredWidth:(CGFloat)cardWidth;
...
@property (nonatomic, strong) id <WCImageViewDelegate> __nullable delegate;
...
@property (nonatomic, strong) VideoCard * __nullable videoCard;
@property (nonatomic, strong) id <WCVideoViewDelegate> __nullable delegate;
